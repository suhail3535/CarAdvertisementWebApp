                ...
                <SimpleGrid
                    ...
                    <Stack spacing={6}>
                        <Box width={"160px"} display={"flex"} justifyContent={"space-between"}>
                            <img style={{width:"20%"}}
                                src={logo} alt="logo" />
                    <h1 style={{textAlign:"center",marginTop:"5px",color:"rgb(103,103,200)",fontWeight:"bold"}}>Ride Advertise</h1>



                        </Box>
                        <Text fontSize={'sm'}>© 2023 Ride Advertise. All rights reserved</Text>
                        ...
                        <Stack direction={'row'}>
                            ...
                            <IconButton
                                ...
                                icon={
                                    ...
                                    <img style={{width:"30%"}} src='https://sf.ezoiccdn.com/ezoimgfmt/www.schemecolor.com/wp-content/uploads/google-gmail-logo.png?ezimgfmt=rs:60x60/rscb1/ng:webp/ngcb1' alt='gmail'/>
                                }
                            />
                        </Stack>
                    </Stack>
